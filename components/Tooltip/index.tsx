  ...
  return (
    <TooltipUI.Provider delayDuration={300}>
      <TooltipUI.Root>
        ...
        <TooltipUI.Portal>
          <TooltipUI.Content
            className="z-50 flex max-w-[480px] select-none rounded-lg bg-[var(--bg-base)] px-3 py-2 text-[14px] font-normal leading-5 shadow-md transition-all duration-300 ease-out bg-white border"
            sideOffset={5}
            side="top"
            align="center">
            {content}
